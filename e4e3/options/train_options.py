...
class TrainOptions:
    ...
    def initialize(self):
        self.parser.add_argument('--exp_dir', default="experiment/e4e_lhq25k_encode_stylegan3_bs8_v2", type=str, help='Path to experiment output directory')
        self.parser.add_argument('--dataset_type', default='lhq_encode', type=str, help='Type of dataset/experiment to run')
        self.parser.add_argument('--encoder_type', default='SingleStyleCodeEncoder', type=str, help='Which encoder to use')
        self.parser.add_argument('--model_type', default='stylegan2', choices=['stylegan2', 'stylegan3'], type=str, help='Which stylegan model to use')
        ...
        self.parser.add_argument('--id_lambda', default=0.5, type=float, help='ID loss multiplier factor')
        self.parser.add_argument('--l2_lambda', default=1.0, type=float, help='L2 loss multiplier factor')
        self.parser.add_argument('--d_lambda', default=0.0, type=float, help='D loss multiplier factor')
        self.parser.add_argument('--lambda_ctp', default=0.0, type=float, help='CTP loss multiplier factor')
        self.parser.add_argument('--lambda_retccl', default=0.0, type=float, help='RETCCL loss multiplier factor')

        self.parser.add_argument('--stylegan_weights', default="", type=str,
        ...
        # Discriminator flags
        self.parser.add_argument('--w_discriminator_lambda', default=0.0, type=float, help='Dw loss multiplier')
        ...
        self.parser.add_argument('--update_param_list', nargs='+', type=list, default=None,
